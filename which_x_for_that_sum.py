...
Consider the sequence U(n, x) = x + 2x**2 + 3x**3 + .. + nx**n where x is a real
...
Let us call solve the function solve(m) which returns x such as U(n, x) goes
to m when n goes to infinity.
Note:
