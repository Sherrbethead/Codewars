...
def dirReduc(arr):
    ...
    for i in arr:
        if not stack:
            ...
            if (stack[-1] == 'NORTH' and i == 'SOUTH') or (stack[-1] == 'SOUTH' and i == 'NORTH') or \
               (stack[-1] == 'EAST' and i == 'WEST') or (stack[-1] == 'WEST' and i == 'EAST'):
                stack.pop()
            else:
                stack.append(i)
    return stack
...
print(dirReduc(["SOUTH", "EAST", "NORTH", "WEST", "SOUTH", "NORTH"]))  # ['SOUTH', 'EAST', 'NORTH', 'WEST']